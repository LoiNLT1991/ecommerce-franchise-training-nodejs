...
const CartItemSchemaEntity = new Schema({
  ...
  [BaseFieldName.PRODUCT_CART_PRICE]: { type: mongoose.Schema.Types.Decimal128, default: 0, required: true },
  [BaseFieldName.DISCOUNT_AMOUNT]: { type: mongoose.Schema.Types.Decimal128, default: 0 },
  [BaseFieldName.LINE_TOTAL]: { type: mongoose.Schema.Types.Decimal128, default: 0 },
  [BaseFieldName.FINAL_LINE_TOTAL]: { type: mongoose.Schema.Types.Decimal128, default: 0 },
