...
export default class CartRoute implements IRoute {
  ...
  private initializeRoutes() {
    ...
    this.router.post(API_PATH.CART_ITEM, customerAuthMiddleware(), this.controller.addProductToCart);

    // GET domain:/api/carts/:id - Get item
    this.router.get(API_PATH.CART_ID, customerAuthMiddleware(), this.controller.getItem);
    ...
    this.router.delete(API_PATH.CART_ITEM_ID, customerAuthMiddleware(), this.controller.removeCartItem);
